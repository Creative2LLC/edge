...
export default async function decorate(block) {
  ...
  const fields = {
    ...
    audience: getTextField(block, 'audience', normalizeJsonFieldValue(resourceData.audience)),
    issue: getTextField(block, 'issue', normalizeJsonFieldValue(resourceData.issue)),
    resourceType: getTextField(
      block,
      'resourceType',
      normalizeJsonFieldValue(resourceData.resourceType || resourceData.resource_type),
    ),
