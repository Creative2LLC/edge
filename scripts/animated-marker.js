...
function appendMarkerPaths(svg, style, id) {
  ...
  const loop = 'M25 9 C55 2 101 4 117 17 C129 29 115 43 84 49 C47 56 10 48 5 34 C1 22 21 13 54 9 C84 6 111 11 119 25 C120 10 50 4 25 9';
  const outerLoop = 'M22 11 C51 4 98 5 116 17 C130 30 114 45 82 51 C46 57 9 49 4 35 C0 23 19 14 52 10 C83 7 110 12 121 25 C122 10 52 5 22 11';
